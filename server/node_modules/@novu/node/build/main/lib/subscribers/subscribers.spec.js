...
describe('test use of novus node package - Subscribers class', function () {
    ...
    test('should delete subscriber provider credentials correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockedAxios.put.mockResolvedValue({});
                    return [4, novu.subscribers.deleteCredentials('test-update-subscriber', 'slack')];
                case 1:
                    _a.sent();
                    expect(mockedAxios.delete).toHaveBeenCalled();
                    expect(mockedAxios.delete).toHaveBeenCalledWith("/subscribers/test-update-subscriber/credentials/slack");
                    return [2];
            }
        });
    }); });
    ...
    test('should bulk create subscribers correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockedAxios.post.mockResolvedValue({});
                    return [4, novu.subscribers.bulkCreate([
                            {
    ...
    test('should update subscriber online status', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockedAxios.put.mockResolvedValue({});
                    return [4, novu.subscribers.updateOnlineStatus('test-update-subscriber', true)];
                case 1:
                    _a.sent();
                    expect(mockedAxios.patch).toHaveBeenCalled();
                    expect(mockedAxios.patch).toHaveBeenCalledWith("/subscribers/test-update-subscriber/online-status", {
                        online: true,
                    });
                    return [2];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    expect(mockedAxios.post).toHaveBeenCalled();
                    expect(mockedAxios.post).toHaveBeenCalledWith('/subscribers/test-message-seen/messages/markAs', { mark: { seen: true }, messageId: 'message-123' });
                    return [2];
            }
        });
    }); });
    test('should mark subscriber feed message as read', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockedAxios.post.mockResolvedValue({});
                    return [4, novu.subscribers.markMessageRead('test-message-read', 'message-123')];
                case 1:
                    _a.sent();
                    expect(mockedAxios.post).toHaveBeenCalled();
                    expect(mockedAxios.post).toHaveBeenCalledWith('/subscribers/test-message-read/messages/markAs', { mark: { read: true }, messageId: 'message-123' });
                    return [2];
            }
        });
    }); });
    test('should mark message action as seen', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockedAxios.post.mockResolvedValue({});
                    return [4, novu.subscribers.markMessageActionSeen('test-action-type-sub', 'message-123', shared_1.ButtonTypeEnum.PRIMARY, { status: shared_1.MessageActionStatusEnum.DONE })];
                case 1:
                    _a.sent();
                    expect(mockedAxios.post).toHaveBeenCalled();
                    expect(mockedAxios.post).toHaveBeenCalledWith('/subscribers/test-action-type-sub/messages/message-123/actions/primary', { status: 'done' });
                    return [2];
            }
        });
    }); });
    test('should mark all subscriber messages as read', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockedAxios.post.mockResolvedValue({});
                    return [4, novu.subscribers.markAllMessagesAs('test-action-type-sub', shared_1.MessagesStatusEnum.READ)];
                case 1:
                    _a.sent();
                    expect(mockedAxios.post).toHaveBeenCalled();
                    expect(mockedAxios.post).toHaveBeenCalledWith('/subscribers/test-action-type-sub/messages/mark-all', {
                        markAs: shared_1.MessagesStatusEnum.READ,
                    });
                    return [2];
            }
        });
    }); });
    test('should mark all subscriber messages as read for feed', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockedAxios.post.mockResolvedValue({});
                    return [4, novu.subscribers.markAllMessagesAs('test-action-type-sub', shared_1.MessagesStatusEnum.READ, 'feed-123')];
                case 1:
                    _a.sent();
                    expect(mockedAxios.post).toHaveBeenCalled();
                    expect(mockedAxios.post).toHaveBeenCalledWith('/subscribers/test-action-type-sub/messages/mark-all', {
